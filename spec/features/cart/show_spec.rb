...
RSpec.describe 'Cart show' do
  ...
  describe 'As a visitor' do
    describe 'I visit my cart. Next to each item.' do
      before(:each) do
        @mike = Merchant.create(name: "Mike's Print Shop", address: '123 Paper Rd.', city: 'Denver', state: 'CO', zip: 80_203)
        @meg = Merchant.create(name: "Meg's Bike Shop", address: '123 Bike Rd.', city: 'Denver', state: 'CO', zip: 80_203)
      ...
      it "should see a button or link to increment the count of items I want to purchase. Can't go beyond inventory." do
        visit '/cart'
      ...
      it 'should see a button or link to decrement the count of items I want to puchase.' do
        visit "/items/#{@paper.id}"
        click_on 'Add To Cart'
        visit '/cart'
        @items_in_cart.each do |item|
